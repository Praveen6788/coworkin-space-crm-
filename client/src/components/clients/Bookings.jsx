...
function BookingsPage() {
    ...
    const [formData, setFormData] = useState({
        ...
        workspace:
            initialWorkspace || "Private Cabin"
    ...
    const filteredBranches = branches.filter((branch) => {
        ...
        const matchesWorkspace = workspaceType

            ? branch.pricing.some(
                (item) => item.category === workspaceType
            )
    ...
    const handleBooking = (branch) => {
        ...
        alert(
            `${branch.name} booking lead added successfully`
        );
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
                        ...
                        {filteredBranches.map((branch) => {
                            ...
                            const selectedPlan = workspaceType

                                ? branch.pricing.find(
                                    (item) =>
                                        item.category === workspaceType
                                )
